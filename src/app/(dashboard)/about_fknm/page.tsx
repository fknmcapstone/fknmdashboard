...
const peopleData = [
  {
    name: "Person One",
    imageUrl: "https://media.istockphoto.com/id/1320751178/vector/profile-placeholder-image-gray-silhouette-no-photo.jpg?s=612x612&w=0&k=20&c=ZbP6p5pWjS2skfdRHrH_fE_jm6ymX-6LiZ__9Wb40pw=",
...
export default function AboutFKNM() {
  return (
    <main className={styles.main}>
      <h2 className={styles.heading1}>What is Feeding Kids, Nourishing Minds?</h2>
      ...
      <h2 className={styles.heading2}>About the Feeding Kids, Nourishing Minds Dashboard</h2>
      ...
      <div className={styles.accordion}>
        <Accordion variant="splitted">
          <AccordionItem className={styles.accordionItem}  key="1" aria-label="Steering Committee" title="Steering Committee">
          ...
          <AccordionItem className={styles.accordionItem} key="2" aria-label="Research Team" title="Research Team">
            {defaultContent}
          </AccordionItem>
          <AccordionItem className={styles.accordionItem} key="3" aria-label="Administrative Support" title="Administrative Support">
            {defaultContent}
          </AccordionItem>
          <AccordionItem className={styles.accordionItem} key="4" aria-label="Website Team" title="Website Team">
            {defaultContent}
          </AccordionItem>
        </Accordion>
      </div>
      ...
      <div className={styles.collabContainer}>
        ...
        <div>
          ...
          <a href="https://childnutrition.utoronto.ca/" target="_blank" rel="noopener noreferrer">
        ...
        <div>
          ...
          <a href="https://cgen.utoronto.ca/" target="_blank" rel="noopener noreferrer">
            <div className={styles.collabCard}>
              <Image
